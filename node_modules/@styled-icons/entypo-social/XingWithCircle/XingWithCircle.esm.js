...
export var XingWithCircle = React.forwardRef(function (props, ref) {
    var attrs = {
        "fill": "currentColor",
...
XingWithCircle.displayName = 'XingWithCircle';
export var XingWithCircleDimensions = { height: 20, width: 20 };

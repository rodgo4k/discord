...
export var MediumWithCircle = React.forwardRef(function (props, ref) {
    var attrs = {
        "fill": "currentColor",
...
MediumWithCircle.displayName = 'MediumWithCircle';
export var MediumWithCircleDimensions = { height: 20, width: 20 };

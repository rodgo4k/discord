...
export var TumblrWithCircle = React.forwardRef(function (props, ref) {
    var attrs = {
        "fill": "currentColor",
...
TumblrWithCircle.displayName = 'TumblrWithCircle';
export var TumblrWithCircleDimensions = { height: 20, width: 20 };

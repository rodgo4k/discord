...
export var RdioWithCircle = React.forwardRef(function (props, ref) {
    var attrs = {
        "fill": "currentColor",
...
RdioWithCircle.displayName = 'RdioWithCircle';
export var RdioWithCircleDimensions = { height: 20, width: 20 };

...
export var ExchangeDollar = React.forwardRef(function (props, ref) {
    var attrs = {
        "fill": "currentColor",
...
ExchangeDollar.displayName = 'ExchangeDollar';
export var ExchangeDollarDimensions = { height: 24, width: 24 };

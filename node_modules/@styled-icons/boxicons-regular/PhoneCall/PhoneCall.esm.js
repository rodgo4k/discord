...
export var PhoneCall = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(StyledIconBase, __assign({ iconAttrs: attrs, iconVerticalAlign: "middle", iconViewBox: "0 0 24 24" }, props, { ref: ref }),
        React.createElement("path", { fill: "none", d: "M16.585 19.999l2.006-2.005-2.586-2.586-1.293 1.293a.991.991 0 01-.912.271c-.115-.024-2.842-.611-4.502-2.271s-2.247-4.387-2.271-4.502a.999.999 0 01.271-.912l1.293-1.293-2.586-2.586L4 7.413c.02 1.223.346 5.508 3.712 8.874 3.355 3.356 7.625 3.691 8.873 3.712z" }),
        ...
        React.createElement("path", { d: "M12.999 8c2.103 0 3 .897 3 3h2c0-3.225-1.775-5-5-5v2z" })));
});
